	...
	<form action="TeaServlet" method="post">
		<table>
			...
			<tbody>
				...
				<tr>
					<td><b>性别：</b></td>
					<td><input type="radio" name="teaSex" value="男" ${TEAINFO.teaSex=="男"?"checked":"" } />男 
					<input type="radio" name="teaSex" value="女" ${TEAINFO.teaSex=="女"?"checked":"" } />女</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="teaOri">
							<option value="北京" ${TEAINFO.teaOri=="北京"?"selected":"" }/>北京
                    <option value="内蒙古" ${TEAINFO.teaOri=="内蒙古"?"selected":"" }/>内蒙古
                    <option value="黑龙江" ${TEAINFO.teaOri=="黑龙江"?"selected":"" }/>黑龙江
                    <option value="吉林" ${TEAINFO.teaOri=="吉林"?"selected":"" }/>吉林
                    <option value="辽宁" ${TEAINFO.teaOri=="辽宁"?"selected":"" }/>辽宁
                    <option value="山东" ${TEAINFO.teaOri=="山东"?"selected":"" }/>山东
                    <option value="河北" ${TEAINFO.teaOri=="河北"?"selected":"" }/>河北
                    <option value="河南" ${TEAINFO.teaOri=="河南"?"selected":"" }/>河南
                    <option value="湖南" ${TEAINFO.teaOri=="湖南"?"selected":"" }/>湖南
                    <option value="湖北" ${TEAINFO.teaOri=="湖北"?"selected":"" }/>湖北
                    <option value="甘肃 " ${TEAINFO.teaOri=="甘肃 "?"selected":"" }/>甘肃 
                    <option value="青海 " ${TEAINFO.teaOri=="青海"?"selected":"" }/>青海
                    <option value="西藏" ${TEAINFO.teaOri=="西藏"?"selected":"" }/>西藏
                    <option value="新疆" ${TEAINFO.teaOri=="新疆"?"selected":"" }/>新疆
                    <option value="云南" ${TEAINFO.teaOri=="云南"?"selected":"" }/>云南
                    <option value="四川" ${TEAINFO.teaOri=="四川"?"selected":"" }/>四川
                    <option value="广州" ${TEAINFO.teaOri=="广州"?"selected":"" }/>广州
                    <option value="山西" ${TEAINFO.teaOri=="山西"?"selected":"" }/>山西
                    <option value="福建" ${TEAINFO.teaOri=="福建"?"selected":"" }/>福建
                    <option value="江苏" ${TEAINFO.teaOri=="江苏"?"selected":"" }/>江苏
                    <option value="江西" ${TEAINFO.teaOri=="江西"?"selected":"" }/>江西
                    <option value="陕西" ${TEAINFO.teaOri=="陕西"?"selected":"" }/>陕西
					</select></td>
				</tr>
				<tr>
					<td><b>职业：</b></td>
				...
				<tr>
					...
					<td><select name="teaEdu">
							<option value="本科" ${TEAINFO.teaEdu=="本科"?"selected":"" }/>本科
							<option value="研究生" ${TEAINFO.teaEdu=="研究生"?"selected":"" }/>研究生
							<option value="博士" ${TEAINFO.teaEdu=="博士"?"selected":"" } />博士
							<option value="博士后" ${TEAINFO.teaEdu=="博士后"?"selected":"" }/>博士后
							<option value="专科" ${TEAINFO.teaEdu=="专科"?"selected":"" }/>专科
					</select></td>
				</tr>
				<tr>
					<td><b>民族：</b></td>
					<td><select name="teaNat">
							 <option value="汉族" ${TEAINFO.teaNat=="汉族"?"selected":"" }/>汉族
                    <option value="蒙族" ${TEAINFO.teaNat=="蒙族"?"selected":"" }/>蒙族
                    <option value="壮族" ${TEAINFO.teaNat=="壮族"?"selected":"" }/>壮族
                    <option value="满族" ${TEAINFO.teaNat=="满族"?"selected":"" }/>满族
                    <option value="藏族" ${TEAINFO.teaNat=="藏族"?"selected":"" }/>藏族
                    <option value="回族" ${TEAINFO.teaNat=="回族"?"selected":"" }/>回族
                    <option value="苗族" ${TEAINFO.teaNat=="苗族"?"selected":"" }/>苗族
                    <option value="维吾尔族" ${TEAINFO.teaNat=="维吾尔族"?"selected":"" }/>维吾尔族
					</select></td>
				</tr>
				<tr>
					<td><b>手机号码： 
