...
<body bgcolor="#FFFFFF">
    ...
    <table>
        <thead>
            <tr>
                <th bgcolor="#0099FF" colspan="2"><font color="#FFFFFF" size="+3" face="微软雅黑"><b>学生注册</b></font></th>
            </tr>        
        </thead>
        ...
        <tbody>
            <tr>
                ...
                <td width="45%"><input type="text" name="stuNum" required placeholder="请输入学号" id="t1" onBlur="checkaccount()"/><label id="l1">&nbsp;</label>
                </td>
            </tr>
            <tr>
                <td><b>性别：</b></td>
                <td><input type="radio" name="stuSex" value="男" checked="checked"/>男
                <input type="radio" name="stuSex" value="女"/>女</td>
            </tr>
            <tr>
                <td><b>密码（至少8位）：</b><br/><font size="-3">请输入密码，区分大小写。</font></td>
                <td><input type="password" name="stuPass" required placeholder="请输入密码" id="t2" onBlur="password1()"/><label id="l2">&nbsp;</label></td>
            </tr>
            <tr>
                <td><b>确认密码（至少8位）：</b><br/><font size="-3">请再输入一遍密码。</font></td>
                <td><input type="password" name="stuPass" required placeholder="请再输入密码" id="t3" onBlur="password2()"/><label id="l3">&nbsp;</label></td>
            </tr>
            <tr>
                <td><b>真实姓名：</b></td> 
                <td><input type="text" name="stuName" required placeholder="请输入真实姓名" id="t4" onBlur="checkname()"/><label id="l4">&nbsp;</label></td>           
            </tr>
            <tr>
                <td><b>年龄：</b></td> 
                <td><input type="text" name="stuAge" required placeholder="请输入年龄" id="t8" onBlur="checkage()"/><label id="l8">&nbsp;</label></td>           
            </tr>
            <tr>
                <td><b>地区：</b></td>
            ...
            <tr>
                <td><b>手机号码：</td>
                <td><input type="tel" name="stuPhone" placeholder="请输入有效的手机号码" required id="t6" onBlur="checktel()"/><label id="l6">&nbsp;</label></td>
            </tr>
            <tr>
                <td><b>班级编号：</td>
                <td><input type="tel" name="classId" placeholder="请输入班级编号" id="t7" onBlur="checkclass()"/><label id="l7">&nbsp;</label></td>
            </tr>
        </tbody>
    </table>
    <br/>
